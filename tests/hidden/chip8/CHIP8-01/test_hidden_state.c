...
// FNV-1a of the canonical power-on state (see challenge test for the
// exact state definition).
#define EXPECT_INITIAL 0x8816D7C5u

// FNV-1a of a hidden state:
//   memory[4095] = 0xFF
//   V[0] = 0x01
//   PC = 0x0200, I = 0, SP = 0, stack = 0
//   delay_timer = 0, sound_timer = 0x3C
//   keys released, framebuffer black
#define EXPECT_HIDDEN_STATE 0xB095B735u
